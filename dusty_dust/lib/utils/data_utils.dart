...
class DataUtils {
  // static -> 프로그래밍적 의미 없고 단순 편의성을 위해서 사용함

  static String getTimeFromDateTime({required DateTime dateTime}) {
    return '${dateTime.year}-${dateTime.month}-${getTimeFormat(dateTime.day)} ${getTimeFormat(dateTime.hour)}:${getTimeFormat(dateTime.minute)}';
  }
