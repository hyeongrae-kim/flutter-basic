...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void onSettingsPop() async {
    // navigator 돌려 받는 값이 pop하고 나서 돌려받을 값. 미래 값이므로 사용
    // list - add, naviagator - push
    // [HomeScreen(), SettingsScreen()] - router Stack?
    // route == screen 동의어
...
class _Footer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      // container을 써도 되지만 뉘앙스 차이가 있음. SizedBox를 쓰는게 좀 더 better
